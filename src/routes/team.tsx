...
export const TEAM = [
  { role: "Chairman", name: "Chairman", img: chairman },
  { role: "Managing Director", name: "Managing Director", img: md },
  { role: "CEO", name: "Chief Executive Officer", img: ceo },
  { role: "Director", name: "Director", img: director },
];
    ...
    <SiteShell>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {TEAM.map((m) => (
            <div key={m.role} className="card-lift rounded-3xl border border-border bg-card shadow-soft overflow-hidden">
              <div className="img-zoom relative aspect-[3/4] bg-muted">
                ...
                <div className="absolute inset-x-5 bottom-4 text-white">
                  ...
                  <div className="font-display text-xl font-semibold">{m.role}</div>
                </div>
              </div>
            </div>
          ))}
